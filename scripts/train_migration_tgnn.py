#!/usr/bin/env python3
"""Train PyG Temporal GNN for node migration prediction (stay/migrate/isolated)."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train TGNN for node migration prediction.")
...
def main() -> int:
    ...
    print(f"Migration TGNN complete: {result}")
    return 0
