            ...
            rows.append(
                {
                    ...
                    "source_feature": signal.get("source_feature", "ret_1m_past"),
                    ...
                    "leader_feature_value": float(signal.get("leader_feature_value", np.nan)),
                    "follower_feature_value": float(signal.get("follower_feature_value", np.nan)),
